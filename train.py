...
from models import Seq2Seq, MLP_D, MLP_G, MLP_I, MLP_I_AE, JSDistance, Seq2SeqCAE
...
def parse_args():
    ...
    parser.add_argument('--load_pretrained', type=str, default='1593075369',
...
if __name__ == '__main__':
    ...
    if args.reload_exp or args.load_pretrained:
        ...
        with open('./output/{}/vocab.json'.format(args.outf), 'w', encoding='utf-8') as f:
            ...
            if args.update_base:
                ...
                if niter_global % 100 == 0:
                    ...
                    if niter_global % 30000 == 0:
                        ...
                        # evaluate with lm
                        if not args.no_earlystopping and epoch > args.min_epochs:  # 20
